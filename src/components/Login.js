    ...
    <div className="relative flex flex-col min-h-screen overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <form
          ...
          className="w-3/12 absolute p-12 bg-black bg-opacity-70 rounded text-white"
        >
          ...
          {!isSignInForm && (
            <input
              ...
              className="p-2 my-4 block w-full bg-black bg-opacity-40 border border-white-500"
            /> 
          )}
          <input
            ref={email}
          ...
          <button
            className="p-3 my-4 w-full bg-red-700 text-white rounded bg-black"
